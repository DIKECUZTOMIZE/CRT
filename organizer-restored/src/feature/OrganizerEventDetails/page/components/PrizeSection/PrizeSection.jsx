...
const getCategoryTabLabel = (category = "") => {
  ...
  if (name.includes("custom") || name.includes("other") || name.includes("general")) {
    return raw;
  }
      ...
      {sortedCategories.length > 1 && (
        <div className="flex snap-x snap-mandatory gap-1.5 overflow-x-auto pb-1 scrollbar-none">
          {sortedCategories.map((category, idx) => {
            ...
            const label = getCategoryTabLabel(category.category);
              ...
              <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <h4 className="truncate text-[11px] font-bold uppercase tracking-wide text-slate-200 sm:text-xs">
